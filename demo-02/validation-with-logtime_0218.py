...
def compare_groups(found_locations, found_coords, truth_locations, truth_coords):
    ...
    # Convert truth locations to lowercase
...
def validate(file_path, weights_list):
    ...
    log_filename = "./demo-02/validation_log.txt"
    ...
    with open(log_filename, 'w') as log_file:
        ...
        for episode in data["episodes"]:
            ...
            for i in range(len(weights_list)):
                ...
                log_print("Top 3 Rated Locations: ", loc_names) # can output the scores with the locs if needed

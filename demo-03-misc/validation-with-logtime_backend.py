...
from backend_excel import create_spreadsheet
...
def print_formatted_list(lst, fuzz_print=False):
    ...
    res = "\n" + tab_str + "[" if fuzz_print else "Top NER from text: ["
...
def validate(file_path, weights_list):
    ...
    with open(log_filename, 'w') as log_file:
        ...
        for episode in data["episodes"]:
            ...
            if filename != "transcript-040324.txt":
                continue
            ...
            backend_info = analyze_transcript(text_info, "geonames", components, weights_list, excel_function = create_spreadsheet, backend_catch=True)
            ...
            for i in range(len(weights_list)):
                ...
                # log_print(print_formatted_list(relevant_locations[i]))
...
if __name__ == "__main__":
    ...
    validate("episode-truths-v3.json", weights_list)
